...
enrich_plot = function(geneList, geneSet, geneSetID,
                      title = "", color = "green", base_size = 11 ,
                       rel_heights = c(1.5, 0.5, 1), subplots = 1:3,
                       pvalue_table = FALSE, ES_geom = "line")
## geneList is the ranked gene score named by gene symbol or ID
## geneSet is a list of gene sets, like KEGG, GOBP
## geneSetID is a vector of term name, like KEGG_REGULATION_OF_AUTOPHAGY, in geneSet
{
